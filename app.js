/* VitaBahn — investor brief. Behaviour split out of the approved page, unchanged
   except the lead form now submits to Netlify Forms instead of opening a mail app. */
...
(function(){'use strict';
  ...
  // form submit → Netlify Forms (captures the lead in the dashboard + emails the team)
